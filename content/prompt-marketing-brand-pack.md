...
ทำเครื่องหมาย [สมมติฐาน] ในทุกข้อที่ Mock Data ยังพิสูจน์ไม่ได้
```
...
10) [สมมติฐาน] ที่ยังต้อง Validate
```
...
ให้ทำเครื่องหมาย [ต้อง Validate Competitor]
```
...
USP สมมติฐาน = “กาแฟดีที่เริ่มง่ายจากชุดทดลอง”
