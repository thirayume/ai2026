const CACHE='ai-workshop-day0-responsive-v4-3-prompt-library';
const LOCAL=['./','./index.html','./style.css','./app.js','./content/manifest.json','./content/day0.md','./content/prompt-cards.md','./content/facilitator-guide.md','./data/spot-the-bug.json','./examples/interactive-quiz.html','./examples/ar-word-hunt.html','./assets/day0/01-workshop-map.png','./assets/day0/02-prompt-formula.png','./assets/day0/03-ar-game-loop.png','./assets/day0/04-challenge-cards.png','./assets/day0/05-ai-safety-check.png','./assets/day0/workshop-intro.mp4','./content/prompt-game-pack.md'
,'./content/prompt-visual-story-pack.md'
,'./content/prompt-ar-pack.md'
,'./content/prompt-review-pack.md'
];
